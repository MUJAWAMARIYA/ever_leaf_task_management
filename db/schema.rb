...
ActiveRecord::Schema.define(version: 2019_10_28_230544) do
  ...
  create_table "task_labels", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["labels_id"], name: "index_task_labels_on_labels_id"
    t.index ["tasks_id"], name: "index_task_labels_on_tasks_id"
  end
