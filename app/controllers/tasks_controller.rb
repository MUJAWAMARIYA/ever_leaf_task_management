class TasksController < ApplicationController
  ...
  def index
    ...
    @tasks = if params[:term]
      ...
      Task.joins("labels.name ILIKE ?", "%#{params[:term1]}%").page params[:page]
    else
  ...
  private
    ...
    def task_params
      params.require(:task).permit(:titles, :content, :start_date, :end_date, :kind_of_task, :priority, :status,:user_id)
    end
